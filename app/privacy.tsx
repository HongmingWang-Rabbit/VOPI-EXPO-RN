  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={[styles.section, { color: colors.text }]}>5. Third-Party Services</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.section, { color: colors.text }]}>6. Your Rights</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.section, { color: colors.text }]}>7. Data Retention</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.section, { color: colors.text }]}>8. Children's Privacy</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.section, { color: colors.text }]}>9. Changes to This Policy</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
